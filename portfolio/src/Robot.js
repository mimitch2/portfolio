...
class Robot extends Component {
  ...
  fetchGreeting=()=>{
    const languageCode = languages[Math.floor((Math.random() * languages.length-1))]//randoly choose from array
  ...
  buttonState=()=>{//only enable button if there is input
  ...
  render() {
    return (
      <div className = 'robot-wrapper'>
        <div className="robot">
          ...
          <form onSubmit={(e)=>{if (this.state.userInput.length >    0)this.getNewRobot();
            ...
            <TextField
              ...
              onChange={this.getInput} underlineFocusStyle={{borderBottom: "2px solid rgba(84, 115, 115, .8)"}} fullWidth={false}
            />
          </form>
        ...
        <h3 className="robot-announce"><i className="fas fa-long-arrow-alt-left"></i>&nbsp;&nbsp;Do you want robots? Because this is how you get robots.</h3>
      </div>);
  }
}
