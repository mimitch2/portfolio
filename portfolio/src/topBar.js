      ...
      <MuiThemeProvider muiTheme={getMuiTheme(darkBaseTheme)}>
        <AppBar title="MJM Web Developing"
          ...
          style = {{backgroundColor: '#2B9395',
            width: '100vw'}}
          titleStyle = {{fontSize: '2.0em', fontWeight: 'bold', textTransform: 'uppercase'}}
